...
function db(): PDO
{
    ...
    if ($count === 0) {
        ...
        $items = [
            ...
            ['Citrus Spark', 'Fresh orange, lime, ginger and a bright splash of sparkling water.', 'Drinks', 5.50, '🍊' 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
